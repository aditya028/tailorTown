...
export default function Signup() {
  ...
  const handleRegister = () => {
    if (email.length <= 5 || name.length <= 3 || password.length <= 3)
      return console.log("please enter valid fields");
    if (password != rePassword) return console.log("password do not match");
